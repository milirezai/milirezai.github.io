/* =====================================================================
   WORK-MILIPAY.JS — behavior for the MiliPay project detail page.
   ...
   Visible TEXT lives in work-milipay.html itself, not here — edit the HTML
   to change wording.
===================================================================== */
...
(function(){
  const repo = 'milipay';
  const snapshot = {"stars": 18, "installs": 37, "contributors": 2, "forks": 1, "php": ">= 8.2", "version": "v4.0.2", "laravel": "^12.0 · ^13.0", "issues": 1};
